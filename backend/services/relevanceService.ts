...
export class RelevanceService {
  private readonly stockAliases: Record<string, StockAlias> = {
    'AAPL': {
      symbol: 'AAPL',
   ...
   */
  getTopRelevantArticles(articles: NewsArticle[], symbol: string, maxArticles: number = 5): NewsArticle[] {
   ...
   */
  private calculateRelevanceScore(article: NewsArticle, stockInfo: StockAlias): {
    total: number;
    reasons: string[];
  } {
